...
export const TailwindCssIcon = (props: ComponentPropsWithRef<"svg"> & { size?: number }) => {
    return (


        <svg width={props.size} height={props.size} viewBox="0 0 256 228" version="1.1" preserveAspectRatio="xMidYMid" {...props}>
            <defs>
