...
export const mock_cv_baback: CVData = {
  name: "Hamid Bassam",
  position: "Développeur Produit — SaaS · React / Node.js · 5+ ans d’expérience",
  location: "Strasbourg",
  ...
  summary: "Développeur produit fullstack avec culture startup. J’aide les fondateurs à structurer, scaler et aligner leur plateforme web avec les enjeux business.",
  ...
  experiences: [
    ...
    {
      position: "Développeur produit / Freelance",
    ...
    },
    {
      ...
      tasks: [
        "Conception et développement d’un MVP e-commerce complet : gestion des coffrets, automatisation des emails, dashboard admin.",
        "cadrage fonctionnel, choix technos, cycles courts de validation.",
        "Intégration de la Shopify Storefront API (GraphQL) pour synchroniser les produits, gérer les paniers et suivre les commandes.",
        "Collaboration directe avec la CEO et le marketing pour ajuster les parcours d’achat et optimiser l’expérience client.",
        "Base technique pensée pour le scale rapide, avec modularité, performances et expérience fluide.",
        "Accompagnement stratégique sur le business model et la roadmap technique.",
      ],
      result: [
        "MVP e-commerce livré dans les temps, premières commandes validées,expérience client fluide et personnalisée, gains clairs sur l’efficacité opérationnelle.",
      ],
      technologies: [
        "Next.js",
        "React.js",
  ...
  projects: [
    ...
    },
    {
      ...
      impact: ["Gain de productivité de +20%", "Réduction du temps passif de +50%", "Organisation optimisée des tâches", "Meilleure gestion du temps", "Recul et prise de conscience."],
